#!/usr/bin/env python3
"""Mandatory technical tests for the ONE Q030 original-gate precision audit — validator repair R1.

R1 fixes only T006 key lookup: the result schema uses
T_MM_model_quadratic, not a literal T_MM key. No scientific gate, tolerance,
input, or audit value is changed.
"""
...
def main() -> int:
    ...
    ts.append(test(
        ...
        all(
            ...
            and "T_MM_model_quadratic" in d.get("terms", {})
