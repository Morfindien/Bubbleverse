...
d={
  "q":"Q018",
  "run_id":"Q018-PLANCK-LIKELIHOOD-BRIDGE-V1",
  "result_id":"R-Q018-EDE-PLANCK-LIKELIHOOD-BRIDGE-001",
...
PY
python -m py_compile q018_planck_likelihood_bridge_v1.py q018_tests_v1.py
python - <<'PY'
import yaml,json
yaml.safe_load(open("q018_planck_likelihood_bridge_v1_config.yml"))
