...
# V4 is CamSpec-only and first revalidates exact scalar start semantics. Reuse the exact validated V2 CamSpec bootstrap and do not
...
runtime={
 'q':'Q-032','run_id':'Q032-EXACT-START-CONFORMANCE-ADDBACK-V4','result_id':'R-Q032-EDE-CAMSPEC-ADDBACK-004',
 ...
 'program_hashes':{
   'q032_exact_start_addback_v4.py':digest('q032_exact_start_addback_v4.py'),
...
pathlib.Path('q032_runtime/q032_exact_start_runtime_v4.json').write_text(json.dumps(runtime,indent=2,sort_keys=True)+'\n')
print('Q032_V4_CONTEXT_CONTINUITY_GATE=PASS')
print('Q032_V4_BACKEND_IDENTITY_GATE=PASS')
print('Q032_V4_CAMSPEC_RUNTIME_GATE=PASS')
PY
