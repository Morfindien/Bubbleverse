...
# Q042 V11 is a merge-job dependency-bootstrap repair of V10. Science and all numerical settings are unchanged.
# Reuse the exact Q041 V19 cosmology/likelihood runtime; no V19 chain state or science endpoint is used.
...
out={
 'q':'Q-042','case_id':'NOT DOCUMENTED','program_id':'Q042-PREFLIGHT-V11','run_id':'Q042-POLYCHORD-BOBYQA-PREFLIGHT-V11','result_id':'R-Q042-POLYCHORD-BOBYQA-PREFLIGHT-011','status':'PASS',
 'technical_parent_program_id':'Q042-PREFLIGHT-V10','technical_repair':'MERGE_PREFLIGHT_DEPENDENCY_BOOTSTRAP_ONLY_SCIENCE_AND_NUMERICS_UNCHANGED',
 ...
 'sampler_process_isolation':'POLYCHORD_FRESH_RESUME_AND_BOBYQA_EXTERNAL_STARTS_SEPARATE_PYTHON_PROCESSES','cobaya_upgraded':False,'scientific_result':False
}
path=pathlib.Path('q042_runtime/q042_external_runtime_provenance_v11.json');path.write_text(json.dumps(out,indent=2,sort_keys=True)+'\n',encoding='utf-8')
print('Q042_V11_RUNTIME_SOURCE_GATE=PASS polychord_commit='+commit+' pantheon_files='+str(len(manifest)))
PYSETUP
