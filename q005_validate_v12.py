#!/usr/bin/env python3
"""Aggregate and validate Bubbleverse Q-005 HPC V12 split-restart outputs. Smoke is single-evaluate only."""
...
def main():
    ...
    ap.add_argument("--config",default="q005_hpc_v12_config.yml")
    ...
    out={"project":"Q-005-HPC-V12","bubbleverse_q":"Q-005",
