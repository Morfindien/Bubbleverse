...
CURRENT_Q = "Q016"
RUN_ID = "Q016-MATCHED-CMB-SURFACE-V1"
RESULT_ID = "R-Q016-EDE-MATCHED-CMB-SURFACE-001"
...
def main():
    ...
    ap.add_argument("--config",default=str(ROOT/"q016_matched_cmb_surface_v1_config.yml"))
