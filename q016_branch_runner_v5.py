#!/usr/bin/env python3
"""Bubbleverse Q016 V5 continuation-repair branch runner.
...
CURRENT_Q = "Q016"
RUN_ID = "Q016-MATCHED-CMB-SURFACE-V5"
RESULT_ID = "R-Q016-EDE-MATCHED-CMB-SURFACE-005"
...
def run(args):
    ...
    status={"q":CURRENT_Q,"run_id":RUN_ID,"result_id":RESULT_ID,"branch":args.branch,
            ...
            "continuation_parent":{"github_run_id":33693382859,"run_id":"Q016-MATCHED-CMB-SURFACE-V4","head_sha":"596ee68677784deb4c28d1eb5992faf6dcd2c5b1"}}
    ...
    status.update({"status":"COMPLETE","chi2":chi,"minimum":row,
                   ...
                   "runtime_provenance_file":f"q016_v5_source_runtime/setup_{args.branch}.json"})
    write_json(out,status)

def main():
    ap=argparse.ArgumentParser()
    ap.add_argument("--config",default=str(ROOT/"q016_matched_cmb_surface_v5_config.yml"))
