...
def static(a):
 ...
 gates={
  ...
  "WORKFLOW_IDENTITY":"PROGRAM_ID: Q042-PREFLIGHT-V4" in w and "CURRENT_Q: Q-042" in w,
  ...
  "V3_FAILURE_PRESERVED":l.get("technical_parent",{}).get("program_id")=="Q042-PREFLIGHT-V3" and l.get("technical_parent",{}).get("scientific_result")=="NONE",
  "EXACT_V19_BASE_CACHE":"q041-v19-${{ runner.os }}-py311-q032-4dc873a-actcmb-880eacb-lens-b386ddb-desi-b7b8a36" in w,
  "SEPARATE_POLYCHORD_CACHE":"q042-v4-polychord-${{ runner.os }}-py311-pc1222" in w and "path: external/PolyChordLite" in w,
  "Q042_CORE_HELPER":"q042_prepare_frozen_core_v4.sh both" in w and "bash q041_prepare_frozen_core_v19.sh both" not in w,
  ...
  "PILOT_CACHE_FAIL_CLOSED":"q042-v4-${{ runner.os }}-py311-cobaya356-q032-4dc873a-pc1222-pybobyqa150-pantheonplus" in w and "fail-on-cache-miss: true" in w,
  "REGISTRY_ENTRY":entry.get("q")==Q and entry.get("status")=="ACTIVE" and entry.get("workflow_id")=="q042-planck-portability-v4.yml",
 ...
 print("Q042_V4_STATIC_TEST_GATE=PASS")
def final(a):
 ...
 if status!="PASS":raise SystemExit(2)
 print("Q042_V4_FINAL_TEST_GATE=PASS")
def parser():
