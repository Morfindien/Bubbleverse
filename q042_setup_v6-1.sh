...
# Q042 V6 is a version-integrity repair of V5. Runtime/science settings are unchanged.
...
out={
 'q':'Q-042','case_id':'NOT DOCUMENTED','program_id':'Q042-PREFLIGHT-V6','run_id':'Q042-POLYCHORD-BOBYQA-PREFLIGHT-V6','result_id':'R-Q042-POLYCHORD-BOBYQA-PREFLIGHT-006','status':'PASS',
 'technical_parent_program_id':'Q042-PREFLIGHT-V5','technical_repair':'STATIC_VERSION_REFERENCE_REPAIR_ONLY_NO_SCIENCE_CHANGE',
...
path=pathlib.Path('q042_runtime/q042_external_runtime_provenance_v6.json');path.write_text(json.dumps(out,indent=2,sort_keys=True)+'\n',encoding='utf-8')
print('Q042_V6_RUNTIME_SOURCE_GATE=PASS polychord_commit='+commit+' pantheon_files='+str(len(manifest)))
PYSETUP
