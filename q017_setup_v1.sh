...
p=Path("q017_results/q017_setup_failure.json")
p.write_text(json.dumps({
  "q":"Q017",
  "run_id":"Q017-PLANCK-DIRECTION-LOCALIZATION-V1",
  "result_id":"R-Q017-EDE-PLANCK-DIRECTION-LOCALIZATION-001",
...
for p,v in expected.items():
    a=m.version(p)
    assert a==v,(p,a,v)
print("Q017_FROZEN_DEPENDENCY_GATE=PASS")
PY
...
print("Q017_CLASS_EDE_GATE=PASS",p)
print("Q017_PLANCK_FULL_MF_INSTALL_GATE=PASS")
PY
...
print("Q017_RUNTIME_PROVENANCE_GATE=PASS")
PY

STAGE="COMPLETE"
trap - ERR
echo "Q017_SETUP_GATE=PASS"
