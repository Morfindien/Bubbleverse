...
p=argparse.ArgumentParser();p.add_argument('--registry',default='bubbleverse_program_registry.json');p.add_argument('--patch',default='q042_program_registry_patch_v11.json');p.add_argument('--output',default='bubbleverse_program_registry.q042-v11.json');a=p.parse_args()
