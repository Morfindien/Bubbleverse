...
Q='Q-041'; PID='Q041-PLANCKPORT-V10'; RID='R-Q041-EDE-DOWNSTREAM-PORTABILITY-010'
...
def static(a):
    ...
    assert ent['q']==Q and ent['status']=='ACTIVE' and ent['workflow_id']=='q041-planck-portability-v10.yml'
    assert ent['scientific_program']=='q041_planck_portability_v10.py'
    wf=pathlib.Path(a.workflow).read_text(encoding='utf-8')
    for token in [PID,'q041_prepare_frozen_core_v10.sh','prepare-nonoverlap','runtime-preflight','P_A6_L6_D2','P_L6_D2','P_A6_D2','P_A6_L6','aggregate']:
    ...
    setup=pathlib.Path('q041_setup_v10.sh').read_text(encoding='utf-8')
    core=pathlib.Path('q041_prepare_frozen_core_v10.sh').read_text(encoding='utf-8')
    ...
    assert 'name: q041-chain-${{ matrix.implementation }}-${{ matrix.combo }}-c${{ matrix.chain }}-v10' in wf
    assert 'pattern: q041-chain-*-v10' in wf
    ...
    assert 'q041-v10-q032core-' in wf
    ...
    current_runtime_refs = [
        'q041_planck_portability_v10.py',
        'q041_planck_portability_tests_v10.py',
        'q041_planck_portability_preregister_v10.json',
        'q041_planck_portability_source_lock_v10.json',
        'q041_setup_v10.sh',
        'q041_prepare_frozen_core_v10.sh',
        'q041-static-v10',
        'q041-environment-v10',
        'q041-chain-*-v10',
        'q041-final-v10',
    ]
    ...
    stale_runtime_patterns = [
        r'q041_planck_portability_tests_v[3-9]\\.py',
        r'q041_planck_portability_preregister_v[3-9]\\.json',
        r'q041_planck_portability_source_lock_v[3-9]\\.json',
        r'q041_planck_portability_v[3-9]\\.py',
        r'q041_setup_v[3-9]\\.sh',
        r'q041_prepare_frozen_core_v[3-9]\\.sh',
        r'q041-(?:static|environment|final)-v[3-9]\\b',
        r'q041-chain-[^\\n]*-v[3-9]\\b',
    ]
