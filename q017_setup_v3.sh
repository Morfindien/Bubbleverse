...
p=Path("q017_results/q017_setup_failure_v3.json")
p.write_text(json.dumps({
  "q":"Q017",
  "run_id":"Q017-PLANCK-DIRECTION-LOCALIZATION-V3",
...
for p,v in expected.items():
    a=m.version(p)
    assert a==v,(p,a,v)
print("Q017_V3_FROZEN_DEPENDENCY_GATE=PASS")
PY
...
print("Q017_V3_CLASS_EDE_GATE=PASS",p)
print("Q017_V3_PLANCK_FULL_MF_INSTALL_GATE=PASS")
PY
...
print("Q017_V3_RUNTIME_PROVENANCE_GATE=PASS")
PY

STAGE="COMPLETE"
trap - ERR
echo "Q017_V3_SETUP_GATE=PASS"
