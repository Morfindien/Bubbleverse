...
CONFIG_NAME="q014_external_viability_v4_config.yml"
...
def load_records(paths:list[str])->list[dict[str,Any]]:
    ...
    for raw in paths:
        ...
        for f in candidates:
            ...
            if d.get("q")=="Q014" and d.get("run_id")=="Q014-EXTERNAL-VIABILITY-V4" and "mode" in d:
...
def aggregate(records:list[dict[str,Any]], c:Mapping[str,Any], depth:str)->dict[str,Any]:
    from q014_external_viability_v4 import expected_tasks
    ...
    result={
      "case_id":c["project"]["case_id"],"q":"Q014","run_id":"Q014-EXTERNAL-VIABILITY-V4",
    ...
    result["journal_update"]={
      ...
      "program":"q014_external_viability_v4.py","workflow":"q014-external-viability-v4.yml",
