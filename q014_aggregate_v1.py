...
def load_records(paths:list[str])->list[dict[str,Any]]:
    ...
    for raw in paths:
        ...
        for f in candidates:
            ...
            if d.get("q")=="Q014" and d.get("run_id")=="Q014-EXTERNAL-VIABILITY-V1" and "mode" in d:
...
def aggregate(records:list[dict[str,Any]], c:Mapping[str,Any], depth:str)->dict[str,Any]:
    from q014_external_viability_v1 import expected_tasks
    ...
    result={
      "case_id":c["project"]["case_id"],"q":"Q014","run_id":"Q014-EXTERNAL-VIABILITY-V1",
    ...
    result["journal_update"]={
      ...
      "program":"q014_external_viability_v1.py","workflow":"q014-external-viability-v1.yml",
