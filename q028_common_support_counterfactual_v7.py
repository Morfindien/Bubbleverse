#!/usr/bin/env python3
"""
Bubbleverse Q028 V7 — split/checkpointed Criterion B+ continuation.

V7 supersedes V6 as an execution architecture, not as a scientific result.
...
RUN = "Q028-FULLMF-COMMON-SUPPORT-COUNTERFACTUAL-V7"
RESULT = "R-Q028-EDE-FULLMF-COMMON-SUPPORT-COUNTERFACTUAL-007"
...
def family_filename(mask: int, ek: str) -> str:
    return f"q028_v7_family_m{mask}_{ek}.json"


def precision_filename(mask: int, ek: str) -> str:
    return f"q028_v7_precision_m{mask}_{ek}.json"
...
def parser() -> argparse.ArgumentParser:
    ...
    ap.add_argument(
        "--config", default="q028_common_support_counterfactual_v7_config.yml"
    )
