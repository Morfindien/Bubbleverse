...
def static(a):
 ...
 gates={
  ...
  "WORKFLOW_IDENTITY":"PROGRAM_ID: Q042-PREFLIGHT-V7" in w and "CURRENT_Q: Q-042" in w,
  ...
  "V6_TIMEOUT_PRESERVED":l.get("technical_parent",{}).get("program_id")=="Q042-PREFLIGHT-V6" and l.get("technical_parent",{}).get("scientific_result")=="NONE" and "TIMEOUT" in l.get("technical_parent",{}).get("failure_class",""),
  "EXACT_V19_BASE_CACHE":"q041-v19-${{ runner.os }}-py311-q032-4dc873a-actcmb-880eacb-lens-b386ddb-desi-b7b8a36" in w,
  "V6_CACHE_REUSE":"q042-v6-${{ runner.os }}-py311-cobaya356-q032-4dc873a-pc1222-pybobyqa150-pantheonplus" in w and "Restore prior successful Q042 V6 full runtime cache" in w,
  ...
  "PILOT_CACHE_FAIL_CLOSED":"q042-v7-${{ runner.os }}-py311-cobaya356-q032-4dc873a-pc1222-pybobyqa150-pantheonplus" in w and "fail-on-cache-miss: true" in w,
  ...
  "WORKFLOW_SELF_REFERENCE":"--workflow .github/workflows/q042-planck-portability-v7.yml" in w,
  "WORKFLOW_REGISTRY_PATCH_SELF_REFERENCE":"--registry-patch q042_program_registry_patch_v7.json" in w and "--registry-patch q042_program_registry_patch_v6.json" not in w,
  "PILOT_RESULT_VERSION":"q042_pilot_result_v7.json" in p and all(x not in p for x in ("q042_pilot_result_v4.json","q042_pilot_result_v5.json","q042_pilot_result_v6.json")),
  "REGISTRY_ARTIFACT_VERSION":all(str(x).endswith("v7") or "*-v7" in str(x) for x in entry.get("result_artifacts",[])) and len(entry.get("result_artifacts",[]))==4,
  "REGISTRY_ENTRY":entry.get("q")==Q and entry.get("status")=="ACTIVE" and entry.get("workflow_id")=="q042-planck-portability-v7.yml",
 ...
 print("Q042_V7_STATIC_TEST_GATE=PASS")
def final(a):
 ...
 if status!="PASS":raise SystemExit(2)
 print("Q042_V7_FINAL_TEST_GATE=PASS")
def parser():
