...
# Q042 V3 is a deployment-only repair of V2. Reuse the exact Q041 V19
...
out={
 'q':'Q-042','case_id':'NOT DOCUMENTED','program_id':'Q042-PREFLIGHT-V3','run_id':'Q042-POLYCHORD-BOBYQA-PREFLIGHT-V3','result_id':'R-Q042-POLYCHORD-BOBYQA-PREFLIGHT-003','status':'PASS',
 'technical_parent_program_id':'Q042-PREFLIGHT-V2','technical_repair':'ADD_OPENMPI_BUILD_PREREQUISITES_NO_SCIENCE_CHANGE',
...
path=pathlib.Path('q042_runtime/q042_external_runtime_provenance_v3.json');path.write_text(json.dumps(out,indent=2,sort_keys=True)+'\n',encoding='utf-8')
print('Q042_V3_RUNTIME_SOURCE_GATE=PASS polychord_commit='+commit+' pantheon_files='+str(len(manifest)))
PYSETUP
