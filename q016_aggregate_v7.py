#!/usr/bin/env python3
"""Q016 V7 staged aggregation and primary endpoint certification."""
import argparse,json,math
from pathlib import Path
import yaml

Q="Q016"; RUN="Q016-MATCHED-CMB-SURFACE-V7"; RESULT="R-Q016-EDE-MATCHED-CMB-SURFACE-007"
...
def main():
    ...
    ap.add_argument("--config",default="q016_matched_cmb_surface_v7_config.yml")
