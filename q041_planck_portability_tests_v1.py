...
Q='Q-041'; PID='Q041-PLANCKPORT-V1'; RID='R-Q041-EDE-DOWNSTREAM-PORTABILITY-001'
...
def static(a):
    ...
    assert ent['q']==Q and ent['status']=='ACTIVE' and ent['workflow_id']=='q041-planck-portability-v1.yml'
    assert ent['scientific_program']=='q041_planck_portability_v1.py'
