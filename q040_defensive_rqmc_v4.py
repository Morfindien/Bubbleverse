#!/usr/bin/env python3
"""Bubbleverse Q-040 defensive native-prior RQMC CMB marginalization V4.

Technical V4 repairs only deployment/workflow packaging after GitHub run
34256042442. V3 passed static, parent, environment and prepare gates, but every
m=9 RQMC shard stopped before scientific execution because the separately
packaged local composite retry action was absent from the repository path
.github/actions/q040-download-retry-v3/action.yml. V4 removes that external
local-action dependency and inlines the same bounded three-attempt artifact
retry logic directly into the workflow. The exact V1 randomized-QMC seed
namespace and every scientific/numerical setting remain frozen.
...
The workflow is intentionally multi-job and adaptively gated.  One user launch
...
RUN_ID = "Q040-DEFENSIVE-RQMC-CMB-MARGINAL-V4"
RESULT_ID = "R-Q040-EDE-DEFENSIVE-RQMC-CMB-MARGINAL-004"
MATH_RESULT_ID = "R-Q040-MATH-DEFENSIVE-MARGINAL-001"
INTERVENTION = "DEFENSIVE_NATIVE_PRIOR_RQMC_CMB_MARGINALIZATION_V1"
TECHNICAL_PARENT_PROGRAM_ID = "Q040-RQMC-V3"
TECHNICAL_PARENT_GITHUB_RUN_ID = 34256042442
TECHNICAL_PARENT_HEAD_SHA = "289d1b3aca238b58e797b03978d15258c465d52c"
TECHNICAL_PARENT_FAILURE_CLASS = "LOCAL_COMPOSITE_ACTION_MISSING_BEFORE_RQMC_M9_SHARD_EXECUTION"
# Preserve V1 randomized-QMC points exactly across V2/V3/V4 technical-only repairs.
