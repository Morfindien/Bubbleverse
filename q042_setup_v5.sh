...
# Q042 V5 is a cold-cache transport-only repair of V3. Reuse the exact Q041 V19
...
out={
 'q':'Q-042','case_id':'NOT DOCUMENTED','program_id':'Q042-PREFLIGHT-V5','run_id':'Q042-POLYCHORD-BOBYQA-PREFLIGHT-V5','result_id':'R-Q042-POLYCHORD-BOBYQA-PREFLIGHT-005','status':'PASS',
...
path=pathlib.Path('q042_runtime/q042_external_runtime_provenance_v5.json');path.write_text(json.dumps(out,indent=2,sort_keys=True)+'\n',encoding='utf-8')
print('Q042_V5_RUNTIME_SOURCE_GATE=PASS polychord_commit='+commit+' pantheon_files='+str(len(manifest)))
PYSETUP
