...
Q='Q-040'; PROGRAM_ID='Q040-RQMC-V3'; RESULT_ID='R-Q040-EDE-DEFENSIVE-RQMC-CMB-MARGINAL-003'
...
def static(args):
    import q040_defensive_rqmc_v3 as q
    g={}
    ...
    gate(g,'WORKFLOW_PROGRAM_GATE','PROGRAM_ID: Q040-RQMC-V3' in wf and 'default: Q040-RQMC-V3' in wf)
    ...
    gate(g,'WORKFLOW_RESULT_TEST_GATE','q040_defensive_rqmc_tests_v3.py result' in wf)
    gate(g,'WORKFLOW_FAILURE_SEAL_GATE','seal-failure' in wf and 'DEFENSIVE_MARGINALIZATION_NUMERICAL_VALIDATION_FAIL' in src)
    gate(g,'SAME_RUN_ARTIFACT_RETRY_GATE','./.github/actions/q040-download-retry-v3' in wf and wf.count('./.github/actions/q040-download-retry-v3')>=10)
    gate(g,'ARTIFACT_RETRY_FAIL_CLOSED_GATE','continue-on-error: true' not in wf)
    ...
    gate(g,'V2_TECHNICAL_SUPERSESSION_GATE',ts.get('supersedes_program_id')=='Q040-RQMC-V2' and ts.get('failed_github_run_id')==34247581888 and ts.get('scientific_result_from_failed_run') is False)
