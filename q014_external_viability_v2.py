...
CONFIG_NAME = "q014_external_viability_v2_config.yml"
CURRENT_Q = "Q014"
RUN_ID = "Q014-EXTERNAL-VIABILITY-V2"
CODE_VERSION = "2.0-fixed-h0-parent-artifact-extraction"
...
def run_task(chain: str, mode: str, start_family: str, restart_index: int,
    ...
    rsp = ROOT / "q014_v2_source_runtime" / "setup_imports.json"
    if rsp.exists():
        try:
