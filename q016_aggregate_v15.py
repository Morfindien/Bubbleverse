#!/usr/bin/env python3
"""Q016 V15 targeted Planck-free multistart continuation aggregator."""
import argparse,json,math
from pathlib import Path
import yaml

Q="Q016"; RUN="Q016-MATCHED-CMB-SURFACE-V15"; RESULT="R-Q016-EDE-MATCHED-CMB-SURFACE-015"
...
def main():
    ...
    ap.add_argument("--config",default="q016_matched_cmb_surface_v15_config.yml")
