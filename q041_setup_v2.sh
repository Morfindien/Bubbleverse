...
rec={
 'q':'Q-041','program_id':'Q041-PLANCKPORT-V2','stage':'EXTERNAL_RUNTIME_PROVENANCE','status':'PASS',
...
pathlib.Path('q041_runtime/q041_external_runtime_provenance_v2.json').write_text(json.dumps(rec,indent=2,sort_keys=True)+'\n')
