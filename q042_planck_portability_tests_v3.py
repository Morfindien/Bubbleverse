...
def static(a):
 ...
 gates={
  ...
  "WORKFLOW_IDENTITY":"PROGRAM_ID: Q042-PREFLIGHT-V3" in w and "CURRENT_Q: Q-042" in w,
  ...
  "V2_FAILURE_PRESERVED":l.get("technical_parent",{}).get("program_id")=="Q042-PREFLIGHT-V2" and l.get("technical_parent",{}).get("scientific_result")=="NONE",
  "REGISTRY_ENTRY":entry.get("q")==Q and entry.get("status")=="ACTIVE" and entry.get("workflow_id")=="q042-planck-portability-v3.yml",
 ...
 print("Q042_V3_STATIC_TEST_GATE=PASS")
def final(a):
 ...
 if status!="PASS":raise SystemExit(2)
 print("Q042_V3_FINAL_TEST_GATE=PASS")
def parser():
