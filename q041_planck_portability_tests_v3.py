...
Q='Q-041'; PID='Q041-PLANCKPORT-V3'; RID='R-Q041-EDE-DOWNSTREAM-PORTABILITY-003'
...
def static(a):
    ...
    assert ent['q']==Q and ent['status']=='ACTIVE' and ent['workflow_id']=='q041-planck-portability-v3.yml'
    assert ent['scientific_program']=='q041_planck_portability_v3.py'
    wf=pathlib.Path(a.workflow).read_text(encoding='utf-8')
    for token in [PID,'q041_prepare_frozen_core_v3.sh','prepare-nonoverlap','runtime-preflight','P_A6_L6_D2','P_L6_D2','P_A6_D2','P_A6_L6','aggregate']:
