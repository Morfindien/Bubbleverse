#!/usr/bin/env python3
"""Bubbleverse Q042 V6 — PolyChord + external-start Py-BOBYQA hard preflight.
...
RUN_ID="Q042-POLYCHORD-BOBYQA-PREFLIGHT-V6"
RESULT_ID="R-Q042-POLYCHORD-BOBYQA-PREFLIGHT-006"
...
def static_check(a:argparse.Namespace)->int:
    ...
    write_json(a.output,out);print("Q042_V6_STATIC_GATE=PASS");return 0
...
def prepare_nonoverlap(a:argparse.Namespace)->int:
    ...
    print("Q042_V6_NONOVERLAP_GATE=PASS");return rc
...
def runtime_preflight(a:argparse.Namespace)->int:
    ...
    write_json(a.output,out);print("Q042_V6_RUNTIME_PREFLIGHT_GATE=PASS");return 0
...
def pilot_cell(a:argparse.Namespace)->int:
    ...
    write_json(outdir/"q042_pilot_result_v6.json",rec);print(f"Q042_V6_PILOT_GATE=PASS arm={a.arm} model={a.model}");return 0
...
def merge_pilots(a:argparse.Namespace)->int:
    ...
    rows=[]
    for p in Path(a.input_dir).rglob("q042_pilot_result_v6.json"):
        d=read_json(p)
    ...
    write_json(a.output,out);print("Q042_V6_PREFLIGHT_FINAL_GATE=PASS");return 0
