#!/usr/bin/env python3
"""Bubbleverse Q-040 defensive native-prior RQMC CMB marginalization V3.

Technical V3 repairs only workflow artifact transport after GitHub run
34247581888. V2 successfully completed all scientific/static/environment gates
and RQMC levels m=9..11, then one m=12 HiLLiPoP shard was prevented from
starting by a transient same-run artifact-list HTTP 403 from GitHub's
intermediary. V3 preserves the exact V1 randomized-QMC seed namespace and every
scientific/numerical setting from V2; only artifact retrieval/retry and
technical-failure routing are changed.
...
Q = "Q-040"
PROGRAM_ID = "Q040-RQMC-V3"
RUN_ID = "Q040-DEFENSIVE-RQMC-CMB-MARGINAL-V3"
RESULT_ID = "R-Q040-EDE-DEFENSIVE-RQMC-CMB-MARGINAL-003"
MATH_RESULT_ID = "R-Q040-MATH-DEFENSIVE-MARGINAL-001"
INTERVENTION = "DEFENSIVE_NATIVE_PRIOR_RQMC_CMB_MARGINALIZATION_V1"
TECHNICAL_PARENT_PROGRAM_ID = "Q040-RQMC-V2"
TECHNICAL_PARENT_GITHUB_RUN_ID = 34247581888
TECHNICAL_PARENT_HEAD_SHA = "f7a1484692140c4b37e9c77d4c59fb4b6cd6779e"
TECHNICAL_PARENT_FAILURE_CLASS = "SAME_RUN_ARTIFACT_DOWNLOAD_HTTP_403_INTERMEDIARY_M12_HILLIPOP_SHARD_ABORT"
# Preserve V1 randomized-QMC points exactly across V2 serialization and V3 transport-only repairs.
