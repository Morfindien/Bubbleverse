#!/usr/bin/env python3
"""Bubbleverse Q041 — downstream scientific-consequence portability V13.
...
Q="Q-041"
PROGRAM_ID="Q041-PLANCKPORT-V13"
RUN_ID="Q041-DOWNSTREAM-SCIENTIFIC-CONSEQUENCE-PORTABILITY-V13"
RESULT_ID="R-Q041-EDE-DOWNSTREAM-PORTABILITY-013"
...
def sample(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        write_json(Path(args.output_dir)/"q041_chain_metadata_v13.json",rec)
...
def aggregate(args: argparse.Namespace) -> int:
    load_preregister(args.preregister); load_source_lock(args.source_lock)
    metas=[]
    for p in Path(args.input_dir).rglob("q041_chain_metadata_v13.json"):
        d=read_json(p)
