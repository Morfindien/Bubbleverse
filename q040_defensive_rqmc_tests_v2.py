...
Q='Q-040'; PROGRAM_ID='Q040-RQMC-V2'; RESULT_ID='R-Q040-EDE-DEFENSIVE-RQMC-CMB-MARGINAL-002'
...
def static(args):
    import q040_defensive_rqmc_v2 as q
    g={}
    ...
    gate(g,'WORKFLOW_PROGRAM_GATE','PROGRAM_ID: Q040-RQMC-V2' in wf and 'default: Q040-RQMC-V2' in wf)
    ...
    gate(g,'WORKFLOW_RESULT_TEST_GATE','q040_defensive_rqmc_tests_v2.py result' in wf)
    ...
    gate(g,'V1_TECHNICAL_SUPERSESSION_GATE',ts.get('supersedes_program_id')=='Q040-RQMC-V1' and ts.get('failed_github_run_id')==34244197767 and ts.get('scientific_result_from_failed_run') is False)
    ...
    gate(g,'V1_FAILURE_SOURCE_PROVENANCE_GATE','Q040-RQMC-V1-RUN-34244197767' in sl.get('bubbleverse_technical_evidence',{}))
