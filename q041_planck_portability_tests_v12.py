...
Q='Q-041'; PID='Q041-PLANCKPORT-V12'; RID='R-Q041-EDE-DOWNSTREAM-PORTABILITY-012'
...
def static(a):
    ...
    assert ent['q']==Q and ent['status']=='ACTIVE' and ent['workflow_id']=='q041-planck-portability-v12.yml'
    assert ent['scientific_program']=='q041_planck_portability_v12.py'
    wf=pathlib.Path(a.workflow).read_text(encoding='utf-8')
    for token in [PID,'q041_prepare_frozen_core_v12.sh','prepare-nonoverlap','runtime-preflight','P_A6_L6_D2','P_L6_D2','P_A6_D2','P_A6_L6','aggregate']:
    ...
    setup=pathlib.Path('q041_setup_v12.sh').read_text(encoding='utf-8')
    core=pathlib.Path('q041_prepare_frozen_core_v12.sh').read_text(encoding='utf-8')
    ...
    assert 'q041_chain_metadata_v12.json' in program
    assert 'q041_chain_metadata_v7.json' not in program
    assert program.count('q041_chain_metadata_v12.json') == 2
    ...
    assert 'name: q041-chain-${{ matrix.implementation }}-${{ matrix.combo }}-c${{ matrix.chain }}-v12' in wf
    assert 'pattern: q041-chain-*-v12' in wf
    ...
    assert 'q041-v12-q032core-' in wf
    ...
    current_runtime_refs = [
        'q041_planck_portability_v12.py',
        'q041_planck_portability_tests_v12.py',
        'q041_planck_portability_preregister_v12.json',
        'q041_planck_portability_source_lock_v12.json',
        'q041_setup_v12.sh',
        'q041_prepare_frozen_core_v12.sh',
        'q041-static-v12',
        'q041-environment-v12',
        'q041-chain-*-v12',
        'q041-final-v12',
    ]
