...
# Q042 V9 is a process-isolation repair of V7. Science and all numerical settings are unchanged.
...
out={
 'q':'Q-042','case_id':'NOT DOCUMENTED','program_id':'Q042-PREFLIGHT-V9','run_id':'Q042-POLYCHORD-BOBYQA-PREFLIGHT-V9','result_id':'R-Q042-POLYCHORD-BOBYQA-PREFLIGHT-009','status':'PASS',
...
path=pathlib.Path('q042_runtime/q042_external_runtime_provenance_v9.json');path.write_text(json.dumps(out,indent=2,sort_keys=True)+'\n',encoding='utf-8')
print('Q042_V9_RUNTIME_SOURCE_GATE=PASS polychord_commit='+commit+' pantheon_files='+str(len(manifest)))
PYSETUP
