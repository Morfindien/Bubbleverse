...
# Q042 V7 is a pilot-runtime-budget repair of V6. Science and production settings are unchanged.
...
out={
 'q':'Q-042','case_id':'NOT DOCUMENTED','program_id':'Q042-PREFLIGHT-V7','run_id':'Q042-POLYCHORD-BOBYQA-PREFLIGHT-V7','result_id':'R-Q042-POLYCHORD-BOBYQA-PREFLIGHT-007','status':'PASS',
 'technical_parent_program_id':'Q042-PREFLIGHT-V6','technical_repair':'POLYCHORD_PREFLIGHT_SMOKE_BUDGET_REPAIR_ONLY_PRODUCTION_UNCHANGED',
...
path=pathlib.Path('q042_runtime/q042_external_runtime_provenance_v7.json');path.write_text(json.dumps(out,indent=2,sort_keys=True)+'\n',encoding='utf-8')
print('Q042_V7_RUNTIME_SOURCE_GATE=PASS polychord_commit='+commit+' pantheon_files='+str(len(manifest)))
PYSETUP
