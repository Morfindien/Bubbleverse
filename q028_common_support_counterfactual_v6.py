#!/usr/bin/env python3
"""
Bubbleverse Q028 V6 — split/checkpointed Criterion B+ continuation.

V6 supersedes V5 as an execution architecture, not as a scientific result.
...
RUN = "Q028-FULLMF-COMMON-SUPPORT-COUNTERFACTUAL-V6"
RESULT = "R-Q028-EDE-FULLMF-COMMON-SUPPORT-COUNTERFACTUAL-006"
...
def parser() -> argparse.ArgumentParser:
    ...
    ap.add_argument(
        "--config", default="q028_common_support_counterfactual_v6_config.yml"
    )
