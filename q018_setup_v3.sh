...
d={
  "q":"Q018",
  "run_id":"Q018-PLANCK-LIKELIHOOD-BRIDGE-V3",
  "result_id":"R-Q018-EDE-PLANCK-LIKELIHOOD-BRIDGE-003",
...
PY
python -m py_compile q018_planck_likelihood_bridge_v3.py q018_tests_v3.py
python - <<'PY'
import yaml,json
yaml.safe_load(open("q018_planck_likelihood_bridge_v3_config.yml"))
