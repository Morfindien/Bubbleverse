...
# Q042 V10 is a process-isolation repair of V7. Science and all numerical settings are unchanged.
...
out={
 'q':'Q-042','case_id':'NOT DOCUMENTED','program_id':'Q042-PREFLIGHT-V10','run_id':'Q042-POLYCHORD-BOBYQA-PREFLIGHT-V10','result_id':'R-Q042-POLYCHORD-BOBYQA-PREFLIGHT-010','status':'PASS',
 'technical_parent_program_id':'Q042-PREFLIGHT-V7','technical_repair':'POLYCHORD_MPI_LIFECYCLE_PROCESS_ISOLATION_ONLY_SETTINGS_UNCHANGED',
...
path=pathlib.Path('q042_runtime/q042_external_runtime_provenance_v10.json');path.write_text(json.dumps(out,indent=2,sort_keys=True)+'\n',encoding='utf-8')
print('Q042_V10_RUNTIME_SOURCE_GATE=PASS polychord_commit='+commit+' pantheon_files='+str(len(manifest)))
PYSETUP
