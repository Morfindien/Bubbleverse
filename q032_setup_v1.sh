...
PY
  ...
  mkdir -p "$USER_SITE"
  printf '%s\n%s\n%s\n' "$BUILD_LIB" "$CLASS_DIR" "$CLASS_DIR/python" > "$USER_SITE/bubbleverse_q032_class_ede_v1.pth"
...
runtime={
  'q':'Q-032','run_id':'Q032-PLANCK-TT3PAIR-COMMON-SUPPORT-BRIDGE-V1',
  'result_id':'R-Q032-EDE-PLANCK-TT3PAIR-BRIDGE-001','status':'PASS',
...
pathlib.Path('q032_runtime/q032_hillipop_tt_runtime_v1.json').write_text(
