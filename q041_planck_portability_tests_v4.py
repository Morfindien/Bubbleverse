...
Q='Q-041'; PID='Q041-PLANCKPORT-V4'; RID='R-Q041-EDE-DOWNSTREAM-PORTABILITY-004'
...
def static(a):
    ...
    assert ent['q']==Q and ent['status']=='ACTIVE' and ent['workflow_id']=='q041-planck-portability-v4.yml'
    assert ent['scientific_program']=='q041_planck_portability_v4.py'
    wf=pathlib.Path(a.workflow).read_text(encoding='utf-8')
    for token in [PID,'q041_prepare_frozen_core_v4.sh','prepare-nonoverlap','runtime-preflight','P_A6_L6_D2','P_L6_D2','P_A6_D2','P_A6_L6','aggregate']:
