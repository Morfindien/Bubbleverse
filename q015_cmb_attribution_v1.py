#!/usr/bin/env python3
"""Bubbleverse Q015 V1 — CMB component / multipole / calibration attribution.
...
DEFAULT_CONFIG = "q015_cmb_attribution_v1_config.yml"
CURRENT_Q = "Q015"
RUN_ID = "Q015-CMB-ATTRIBUTION-V1"
RESULT_ID = "R-Q015-EDE-CMB-ATTRIBUTION-001"
...
def build_endpoint_model(chain: str, mode: str, parent: Mapping[str, Any], q011_path: str | Path,
    ...
    values = collect_fixed_values(info, row)
...
def endpoint_attribution(chain: str, q014_path: str | Path, q011_path: str | Path,
    ...
    if chain not in cfg["scientific_surface"]["primary_chains"]:
        raise RuntimeError("CHAIN_GATE=FAIL Q015 V1 primary endpoint attribution is Planck and SPT-only only")
    parent = load_q014(q014_path, cfg)
...
def self_test(path: str | Path, output: str | Path) -> dict[str, Any]:
    ...
    result = {
        "q": CURRENT_Q,
        "run_id": RUN_ID,
        "test_id": "Q015-V1-MANDATORY-RESULT-TESTS",
        "tests": mandatory,
