...
mkdir -p external "$COBAYA_PACKAGES_PATH" q016_results q016_v6_source_runtime
...
p=pathlib.Path("q016_v6_source_runtime")/f"setup_{b}.json"
p.write_text(json.dumps(d,indent=2,sort_keys=True)+"\n")
