...
def collect(cfg: dict[str, Any]) -> dict[str, Any]:
    ...
    summary: dict[str, Any] = {
        ...
        "gates": {},
        "provenance": {
            "config_sha256": sha256_file(ROOT / "q005_hpc_v5_config.yml"),
            "script_sha256": sha256_file(ROOT / "q005_hpc_v5.py"),
        }
    }
...
def main() -> int:
    ...
    ap.add_argument("--config", default="q005_hpc_v5_config.yml")
