...
mkdir -p external "$COBAYA_PACKAGES_PATH" q016_results q016_v8_source_runtime

CURRENT_Q="Q016"
RUN_ID="Q016-MATCHED-CMB-SURFACE-V8"
RESULT_ID="R-Q016-EDE-MATCHED-CMB-SURFACE-008"
STAGE="INITIALIZE"
...
d={
 "q":"Q016","run_id":"Q016-MATCHED-CMB-SURFACE-V8",
 "result_id":"R-Q016-EDE-MATCHED-CMB-SURFACE-008",
...
p=pathlib.Path("q016_v8_source_runtime")/f"setup_{b}.json"
p.write_text(json.dumps(d,indent=2,sort_keys=True)+"\n")
