...
CURRENT_Q = "Q016"
RUN_ID = "Q016-MATCHED-CMB-SURFACE-V4"
RESULT_ID = "R-Q016-EDE-MATCHED-CMB-SURFACE-004"
...
def run(args):
    ...
    status.update({"status":"COMPLETE","chi2":chi,"minimum":row,
                   ...
                   "runtime_provenance_file":f"q016_v4_source_runtime/setup_{args.branch}.json"})
    write_json(out,status)

def main():
    ap=argparse.ArgumentParser()
    ap.add_argument("--config",default=str(ROOT/"q016_matched_cmb_surface_v4_config.yml"))
