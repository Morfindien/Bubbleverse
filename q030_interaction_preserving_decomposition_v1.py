#!/usr/bin/env python3
"""
Bubbleverse Q030 V1 — exact interaction-preserving Q029 decomposition.
...
Q = "Q030"
RUN = "Q030-EDE-INTERACTION-PRESERVING-DECOMPOSITION-V1"
RESULT = "R-Q030-EDE-INTERACTION-PRESERVING-DECOMPOSITION-001"
...
EXPECTED_COMMON_SHA256 = "054220c018e58e902eab98b879eec4a823fb3238a1774ddbacc649bddca8b666"
...
def load_mask_results(directory: str | Path) -> dict[int, dict[str, Any]]:
    ...
    for mask in MASKS:
        p = d / f"q030_v1_mask_m{mask}.json"
        if not p.exists():
...
def parser() -> argparse.ArgumentParser:
    ...
    p.add_argument(
        "--config",
        default="q030_interaction_preserving_decomposition_v1_config.yml",
    )
